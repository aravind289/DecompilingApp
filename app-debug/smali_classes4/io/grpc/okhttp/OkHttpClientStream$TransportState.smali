...
.method private sendBuffer(Lokio/Buffer;ZZ)V
    ...
    .line 394
    iget-boolean v0, p0, Lio/grpc/okhttp/OkHttpClientStream$TransportState;->flushPendingData:Z
...
.method public start(I)V
    ...
    invoke-static {v0}, Lio/grpc/okhttp/OkHttpClientStream;->access$1200(Lio/grpc/okhttp/OkHttpClientStream;)Lio/grpc/internal/StatsTraceContext;
    ...
    iget-boolean v2, p0, Lio/grpc/okhttp/OkHttpClientStream$TransportState;->pendingDataHasEndOfStream:Z

    iget-object v3, p0, Lio/grpc/okhttp/OkHttpClientStream$TransportState;->this$0:Lio/grpc/okhttp/OkHttpClientStream;

    invoke-static {v3}, Lio/grpc/okhttp/OkHttpClientStream;->access$1100(Lio/grpc/okhttp/OkHttpClientStream;)I
    ...
    invoke-virtual {v0, v2, v3, v4, v5}, Lio/grpc/okhttp/OutboundFlowController;->data(ZILokio/Buffer;Z)V
...
.method public transportDataReceived(Lokio/Buffer;Z)V
    ...
    invoke-virtual {v2}, Lio/grpc/okhttp/OkHttpClientStream;->id()I

    move-result v2

    sget-object v3, Lio/grpc/okhttp/internal/framed/ErrorCode;->FLOW_CONTROL_ERROR:Lio/grpc/okhttp/internal/framed/ErrorCode;

    invoke-virtual {v0, v2, v3}, Lio/grpc/okhttp/ExceptionHandlingFrameWriter;->rstStream(ILio/grpc/okhttp/internal/framed/ErrorCode;)V
